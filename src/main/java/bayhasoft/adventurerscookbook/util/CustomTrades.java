...
public class CustomTrades {
    public static void registerCustomTrades() {
        ...
        TradeOfferHelper.registerWanderingTraderOffers(
            factories -> {
                factories.addAll(Identifier.of(AdventurersCookBook.MOD_ID, "emerald_for_tomato_seeds"), (world, entity, random) -> new TradeOffer(
                    new TradedItem(Items.EMERALD, 1),
                    new ItemStack(ModItems.TOMATO_SEEDS, 1),
                    5, 1, 0.075f));
                factories.addAll(Identifier.of(AdventurersCookBook.MOD_ID, "emerald_for_rice_seeds"), (world, entity, random) -> new TradeOffer(
                    new TradedItem(Items.EMERALD, 1),
